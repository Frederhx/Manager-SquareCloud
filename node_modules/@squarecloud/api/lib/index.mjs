...
var GlobalCacheService = class extends BaseCacheService {
  constructor() {
    super(...arguments);
    __publicField(this, "cache", {
      user: void 0
...
var WebsiteApplication = class extends Application {
  ...
  constructor(client, data) {
    ...
    __publicField(this, "network", new NetworkModule(this));
...
// src/index.ts
var SquareCloudAPI = class extends TypedEventEmitter {
  /**
  ...
  constructor(apiKey) {
    ...
    __publicField(this, "applications", new ApplicationsModule(this));
    /** The users module */
    __publicField(this, "users", new UserModule(this));
    /** The global cache service */
    __publicField(this, "cache", new GlobalCacheService());
    assertString(apiKey, "API_KEY");
    this.api = new APIService(apiKey);
  }
};
__publicField(SquareCloudAPI, "apiInfo", {
